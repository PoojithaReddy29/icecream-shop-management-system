<div class="card shadow rounded-0">
    <div class="card-body">
        <div class="w-100 h-100 d-flex flex-column">
            <div class="row">
                <div class="col-8">
                    <h3 style="color: #F61491";>Transaction</h3>
                </div>
...
<script>
    ...
    function calculate_total(){
        ...
        discount = sub * 0.12; // Calculate the tax
        $('#tax').text(parseFloat(discount).toLocaleString('en-US',{style:'decimal',manimumFractionDigits:2,maximumFractionDigits:2}))
        
        total = sub + discount; // Add the tax to the subtotal
        $('#total').text(parseFloat(total).toLocaleString('en-US',{style:'decimal',manimumFractionDigits:2,maximumFractionDigits:2}))
